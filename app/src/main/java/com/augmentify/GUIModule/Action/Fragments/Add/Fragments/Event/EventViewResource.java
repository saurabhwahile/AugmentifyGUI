...
public class EventViewResource
{
	...
	{
		public static final String text = "Event Name";
		
	}
	
	public static final class Date extends Commons
	{
		
	}
	
	public static final class Time extends Commons
	{
		
	}
	
	public static final class Venue extends Commons
	{
		public static final String text = "Venue";
	}
	
	public static final class Description extends Commons
	{
		public static final String text = "Description";
	}

    public static final class Visibilty extends Commons
    {
        public static final String text = "Description";
        public static final String choices[] = {"Public", "Friends", "Private"};
    }

	public static final class DisplayPicture extends Commons
	{
		public static final String text = "Select Event Image";
	}
	
	public static final class CreateEvent extends Commons
	{
		public static final String text = "Create Event";
	}
